...
The documentation is automatically generated from the content of the [docs directory](https://github.com/adnaniazi/fast5_rekindler/tree/master/docs) and from the docstrings
